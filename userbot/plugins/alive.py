...
async def amireallyalive(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"**{EMOJI} Super TG Bot Version :** `{Super TG Bot Version}`\n"
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI} Super TG Bot Version :** `{Super TG Bot Version}`\n"
...
async def amireallyalive(alive):
    ...
    cat_caption += f"**  -Super Tg Bot Version :** `{Super TG Bot Version}`\n"
